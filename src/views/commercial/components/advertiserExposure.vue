  ...
  .advertiser-exposure
    ...
    .type-container
        .canvas-type(
          ...
          span {{ item }}
    #advertiser-exposure.canvas-data-container
</template>
...
<script lang="ts">
  ...
  @Component
  export default class AdvertiserExposure extends Vue {
    ...
    init() {
      const myChart = this.commonEcharts.init(document.getElementById('advertiser-exposure'));
