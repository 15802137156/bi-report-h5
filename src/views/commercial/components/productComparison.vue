<template lang="pug">
  .product-comparison
    ...
    .comparison-container
      .container-half
        #product-comparison-left.canvas-product-comparison-container
        .date 8月18日占比
        .container-half-type
          .type-container
            .canvas-type(
              ...
              .percentage 10%
      .container-half
        #product-comparison-right.canvas-product-comparison-container
        .date 8月19日占比
        .container-half-type
          .type-container
            .canvas-type(
...
<script lang="ts">
  ...
  export default class ProductComparison extends Vue {
    ...
    init() {
      const myChartLeft = this.commonEcharts.init(document.getElementById('product-comparison-left'));
      myChartLeft.setOption(this.option);

      const myChartRight = this.commonEcharts.init(document.getElementById('product-comparison-right'));
