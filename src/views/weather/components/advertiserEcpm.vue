    ...
    .title
      ...
      .source
        .canvas-type(
          ...
          span {{ item }}
    #advertiser-ecpm.adver-space-ecpm
</template>
...
<script lang="ts">
  ...
  @Component
  export default class AdvertiserEcpm extends Vue {

    @Prop({ type: Object, default: () => {} }) commonEcharts: any;

    typeArray:Array<string> = ['穿山甲', '优量汇', '互动', '百度'];
    colorArray:Array<string> =[ '#FFE01E', '#12DEFF', '#BF7AFF', '#FF9372'];
    ...
    init() {
      const myChart = this.commonEcharts.init(document.getElementById('advertiser-ecpm'));
